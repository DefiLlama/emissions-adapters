...
export async function sendMessage(
  ...
  if (webhookUrl === undefined) {
    throw new Error(
      `You are missing an env variable for discord hooks (eg TEAM_WEBHOOK, OUTDATED_WEBHOOK, SPIKE_WEBHOOK...) and this makes it impossible to send the following error message: "${message}"`,
    );
  }
