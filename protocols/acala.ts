...
const acala: Protocol = {
  ...
  Team: manualLinear(start_Team, start_Team + periodToSeconds.week * 17, qty * 0.2525),
  Rewards: manualLinear(start, start + periodToSeconds.week * 72, qty * 0.34),
  Investors: manualLinear(start_Investors, start_Investors + periodToSeconds.week * 18, qty * 0.2913),
  notes: [
