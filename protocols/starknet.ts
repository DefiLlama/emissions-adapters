...
const remainingAfterCliffs =
  combinedAllocation - (initialCliffAmount + april30CliffAmount);
...
const starknet: Protocol = {
  ...
  StarkWare: manualLinear(
    start,
    start + periodToSeconds.year * 4,
    totalSupply * 0.1076,
  ),
  "Grants including DPs": manualLinear(
    start,
    start + periodToSeconds.year * 4,
    totalSupply * 0.1293,
  ),
  "Community Rebates": manualLinear(
    start,
    start + periodToSeconds.year * 4,
    totalSupply * 0.09,
  ),
  "Foundation Strategic Reserves": manualLinear(
    start,
    start + periodToSeconds.year * 4,
    totalSupply * 0.1,
  ),
  ...
  meta: {
    ...
    token:
      "starknet:0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d", // L2 address
    protocolIds: ["3787"],
  },
  categories: {
