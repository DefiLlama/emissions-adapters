...
"Liquidity Incentives":manualLinear(start, start + periodToSeconds.month* 36, qty * 0.871),
"Team": manualLinear(start, start + periodToSeconds.year * 2, qty * 0.05),
  ...
  sources: ["https://arbitrum-exchange.gitbook.io/arbitrumdex/usdarx-tokenomics/usdarx-token"],
  protocolIds: ["2685"],
};
