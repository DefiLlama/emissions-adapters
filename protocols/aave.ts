...
const aave: Protocol = async () => ({
  ...
  notes: ['not all ecosystem reserve funds have been given an emission schedule. Any undefined ecosystem reserve emissions have been excluded from this analysis.'],
